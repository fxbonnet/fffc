...
public class CustomMessage {
	...
	public static final String METADATA_FILE_NOT_FOUND = "ERROR:Input metadata file not found.";
	public static final String METADATA_PARSING = "ERROR:Parsing the metadata CSV file.";
	...
	public static final String CONVERT_FILE_COMPLETED = "Fixed file format is completeted.";
	public static final String METADATA_FILE_PATH = "Please enter the path of Metadata file  :";
	public static final String METADATA_FILE_PATH_ENTERED = "Metadata file path entered :";
