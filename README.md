...
* Python 3.x needs to be installed installed.
* navigate to "fffc_tommy" folder;
* run `python3 fffc_tommy.py test_data/original.data`
* navigate to the `test_data` folder
* ls -lt to find `original.csv` file with processed and structured data.
* $ cat original.csv
* You should see....
